...
function Downloads(){
    ...
    const downloadcard=async()=>{
        ...
        link.href=image;
        link.download="Invitationhub.png";
        link.click();
    }
  ...
  NewYear:"newyear1.png",
    ...
    return(
        <div className="downloads">
            {console.log("last mytemp=>",mytemp)}
            
            <h4 className="doo">{mytemp.length===0?"Downloaded templates are empty":"Downloaded Templates"}</h4>
            <div className="down">
        {mytemp.length>0?
            mytemp.map((item)=>{
                return(
                ...
                <button className="a btn btn-light fs-5 fw-normal bg-gradient shadow pt-2" onClick={downloadcard}>Download</button>
